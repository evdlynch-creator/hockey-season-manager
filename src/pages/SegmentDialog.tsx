      ...
      <DialogContent className="max-w-md">
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4 pt-2">
          <Field>
            ...
            <Input {...register('name')} placeholder="e.g. 2-on-1 Rush, Neutral Zone Regroup…" autoFocus />
          </Field>
          ...
          <Field>
            ...
            <Textarea {...register('notes')} placeholder="Drill details, cues, coaching points…" rows={3} />
          </Field>
